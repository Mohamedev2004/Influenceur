...
class AdminfeatureController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('featurelist')->with('success', 'Feature deleted successfully!');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('featurelist')->with('success', 'Feature added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect to the feature list page with a success message
        return redirect()->route('featurelist')->with('success', 'Feature updated successfully!');
    }
}
