...
public function destroy($id)
{
    ...
    return redirect()->route('packlist')->with('success', 'Pack deleted successfully!');
...
public function store(Request $request)
{
    ...
    $request->validate([
        ...
        'description' => 'required|string|max:500', // Adding validation for description
        'features' => 'array'
    ]);
...
public function update(Request $request, $id)
{
    ...
    $request->validate([
        'name' => 'required|string|max:255',
        'description' => 'required|string|max:5000',  // Add validation for description
    ...
    return redirect()->route('packlist')->with('success', 'Pack updated successfully!');
}
