...
<div class="dashboard__rightt">
    <div class="dash__content ">
        ...
        <div class="flex items-center justify-right">
            <a href="{{route('brandsectoradd')}}">
                <button class="bg-purple-600 text-white py-1 px-3 rounded-md hover:bg-purple-900">Ajouter un Domaine pour brand</button>
            </a>
        </div>
        <!-- sidebar menu end -->
            ...
            <table class="min-w-full border-collapse border border-gray-300 mt-6">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-100">
                        <td class="border border-gray-300 px-4 py-2">Domaine Marque</td>
                        <td class="border border-gray-300 px-4 py-2">
                            <a href="{{route('brandsectoredit')}}">
