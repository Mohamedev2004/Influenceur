            ...
            <table class="min-w-full border-collapse border border-gray-300 mt-6">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-100">
                        <td class="border border-gray-300 px-4 py-2">Caractéristique de Base</td>
                        <td class="border border-gray-300 px-4 py-2">
                            <a href="{{route('featureedit')}}">
                    ...
                    <!-- Pack 2 -->
                    <tr class="hover:bg-gray-100">
                        <td class="border border-gray-300 px-4 py-2">Caractéristique Avancé</td>
                        <td class="border border-gray-300 px-4 py-2">
                            <a href="{{route('featureedit')}}">
                                <button class="bg-purple-600 text-white py-1 px-3 rounded-md hover:bg-purple-900">Modifier</button>
                            </a>
                    ...
                    <!-- Pack 3 -->
                    <tr class="hover:bg-gray-100">
                        <td class="border border-gray-300 px-4 py-2">Caractéristique Premium</td>
                        <td class="border border-gray-300 px-4 py-2">
                            <a href="{{route('featureedit')}}">
                                <button class="bg-purple-600 text-white py-1 px-3 rounded-md hover:bg-purple-900">Modifier</button>
                            </a>
