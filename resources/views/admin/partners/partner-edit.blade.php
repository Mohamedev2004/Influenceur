...
<div class="dashboard__rightt">
    <div class="dash__content ">
        ...
        <div class="max-w-2xl mx-auto mt-10 bg-white p-10 rounded-lg shadow-md">
            <h2 class="text-2xl font-semibold mb-6 text-gray-800">Modifier un Partenaire</h2>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <!-- Nom du Partenaire -->
                <div class="mb-6">
                    <label for="name" class="block text-lg font-medium text-gray-700 mb-2">Nom du Partenaire</label>
                ...
                <!-- Logo du Partenaire -->
                <div class="mb-6">
                    <label for="logo" class="block text-lg font-medium text-gray-700 mb-2">Logo du Partenaire</label>
