            ...
            <div class="col-lg-5 col-xl-4">
                <div class="job__search__section mb-40">
                    <form action="#" class="d-flex flex-column row-30">
                        ...
                        <div class="search__item">
                            ...
                            <div class="position-relative">
                                <div class="nice-select" tabindex="0">
                                    ...
                                    <ul class="list">
                                        <li data-value="1" class="option">Domaine</li>
                                        <li data-value="2" class="option">Domaine</li>
                                        <li data-value="3" class="option">Domaine</li>
                                        <li data-value="4" class="option">Domaine</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="search__item">
                            <h6 class="mb-2 font-20 fw-medium text-dark text-capitalize">Type de collaboration</h6>
                            <div class="position-relative">
                                <div class="nice-select" tabindex="0">
                                    <span class="current">Collaboration</span>
                                    <ul class="list">
                                        <li data-value="1" class="option">Partenariat</li>
                                        <li data-value="2" class="option">Video Promo</li>
                                        <li data-value="3" class="option">Shooting</li>
                                        <li data-value="4" class="option">Photo</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="search__item__list">
                                <div class="d-flex align-items-center justify-content-between list">
                                    <div class="d-flex gap-2 align-items-center checkbox">
                                        <input type="checkbox" name="petite" id="petite">
                            ...
                            <div class="position-relative">
                                <div class="nice-select" tabindex="0">
                                    ...
                                    <ul class="list">
                                        ...
                                        <li data-value="5" class="option">E-commerce</li>
                                        <li data-value="6" class="option">UI/UX Design</li>
                                    </ul>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="row g-30">
                                ...
                                <div class="rts__author__card style__default d-flex flex-column gap-3">
                                    ...
                                    <div class="job__meta w-100 d-flex flex-column gap-3">
                                        <div class="d-flex flex-column align-items-center gap-1">
                                            <a href="{{route('brandprofile')}}" class="job__title h6 mb-0">Al Amin Bali</a>
                                        ...
                                        <a href="{{route('brandprofile')}}" class="apply__btn max-content">View Profile</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-md-6 col-lg-12">
                                <div class="rts__author__card style__default d-flex flex-column gap-3">
                                    ...
                                    <div class="job__meta w-100 d-flex flex-column gap-3">
                                        <div class="d-flex flex-column align-items-center gap-1">
                                            <a href="{{route('brandprofile')}}" class="job__title h6 mb-0">Jonathon Doe</a>
                                            <span class="author">UX Designer</span>
                                        </div>
                                        <div class="d-flex justify-content-center gap-3 flex-wrap">
                                            <div class="d-flex gap-2 align-items-center">
                            ...
                            <div class="col-xl-6 col-md-6 col-lg-12">
                                <div class="rts__author__card style__default d-flex flex-column gap-3">
                                    ...
                                    <div class="job__meta w-100 d-flex flex-column gap-3">
                                        <div class="d-flex flex-column align-items-center gap-1">
                                            <a href="{{route('brandprofile')}}" class="job__title h6 mb-0">Jack Alexander</a>
                                            <span class="author">UX Designer</span>
                                        </div>
                                        <div class="d-flex justify-content-center gap-3 flex-wrap">
                                            <div class="d-flex gap-2 align-items-center">
                            ...
                            <div class="col-xl-6 col-md-6 col-lg-12">
                                <div class="rts__author__card style__default d-flex flex-column gap-3">
                                    ...
                                    <div class="job__meta w-100 d-flex flex-column gap-3">
                                        <div class="d-flex flex-column align-items-center gap-1">
                                            <a href="{{route('brandprofile')}}" class="job__title h6 mb-0">Oliver Josef</a>
                            ...
                            <div class="col-12">
                                <div class="rts__author__card__big style__gradient__two flex-wrap d-flex justify-content-between align-items-center gap-3">
                                    <div class="d-flex gap-3 gap-md-4 flex-column flex-md-row justify-content-start
                                        ...
                                        <div class="job__meta">
                                            <div class="d-flex align-items-start flex-column">
                                                <a href="{{route('brandprofile')}}" class="job__title mb-0 h6 fw-semibold">Michael Roy</a>
                                    ...
                                    <div class="d-flex gap-4 flex-wrap align-items-center">
                                        ...
                                        <a href="{{route('brandprofile')}}" class="apply__btn" aria-label="View Profile">View Profile</a>
                                    </div>
                                </div>
                            </div>
                            <!-- author card end -->
                            ...
                            <div class="col-12">
                                <div class="rts__author__card__big style__gradient__two flex-wrap d-flex justify-content-between align-items-center gap-3">
                                    <div class="d-flex gap-3 gap-md-4 flex-column flex-md-row justify-content-start
                                        ...
                                        <div class="job__meta">
                                            <div class="d-flex align-items-start flex-column">
                                                <a href="{{route('brandprofile')}}" class="job__title mb-0 h6 fw-semibold">Jonathon Doe</a>
                                                <span class="d-block fw-medium">Software Engineer</span>
                                            </div>
                                            <div class="job__tags mt-3 d-flex flex-wrap gap-3">
                                                <a href="#">Creative</a>
                            ...
                            <div class="col-12">
                                <div class="rts__author__card__big style__gradient__two flex-wrap d-flex justify-content-between align-items-center gap-3">
                                    <div class="d-flex gap-3 gap-md-4 flex-column flex-md-row justify-content-start
                                        ...
                                        <div class="job__meta">
                                            <div class="d-flex align-items-start flex-column">
                                                <a href="{{route('brandprofile')}}" class="job__title mb-0 h6 fw-semibold">Jack Alexander </a>
                                                <span class="d-block fw-medium">Software Engineer</span>
                                            </div>
                                            <div class="job__tags mt-3 d-flex flex-wrap gap-3">
                                                <a href="#">Creative</a>
                            ...
                            <div class="col-12">
                                <div class="rts__author__card__big style__gradient__two flex-wrap d-flex justify-content-between align-items-center gap-3">
                                    <div class="d-flex gap-3 gap-md-4 flex-column flex-md-row justify-content-start
                                        ...
                                        <div class="job__meta">
                                            <div class="d-flex align-items-start flex-column">
                                                <a href="{{route('brandprofile')}}" class="job__title mb-0 h6 fw-semibold">Oliver Josef </a>
                                                <span class="d-block fw-medium">Software Engineer</span>
                                            </div>
                                            <div class="job__tags mt-3 d-flex flex-wrap gap-3">
                                                <a href="#">Creative</a>
                            ...
                            <div class="col-12">
                                <div class="rts__author__card__big style__gradient__two flex-wrap d-flex justify-content-between align-items-center gap-3">
                                    <div class="d-flex gap-3 gap-md-4 flex-column flex-md-row justify-content-start
                                        ...
                                        <div class="job__meta">
                                            <div class="d-flex align-items-start flex-column">
                                                <a href="{{route('brandprofile')}}" class="job__title mb-0 h6 fw-semibold">Emma Roy</a>
                                                <span class="d-block fw-medium">Software Engineer</span>
                                            </div>
                                            <div class="job__tags mt-3 d-flex flex-wrap gap-3">
                                                <a href="#">Creative</a>
                            ...
                            <div class="col-12">
                                <div class="rts__author__card__big style__gradient__two flex-wrap d-flex justify-content-between align-items-center gap-3">
                                    <div class="d-flex gap-3 gap-md-4 flex-column flex-md-row justify-content-start
                                        ...
                                        <div class="job__meta">
                                            <div class="d-flex align-items-start flex-column">
                                                <a href="{{route('brandprofile')}}" class="job__title mb-0 h6 fw-semibold">Anastacia Alice</a>
                                                <span class="d-block fw-medium">Software Engineer</span>
                                            </div>
                                            <div class="job__tags mt-3 d-flex flex-wrap gap-3">
                                                <a href="#">Creative</a>
